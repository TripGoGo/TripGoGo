...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c320326b2ad2dd588de2423a35a93637"></script>
                    ...
                    <div class="container" style="margin-top:6vh">
                        ...
                        <div class="row justify-content-center" style="margin-top:3vh">
                            ...
                            <div class="row justify-content-center" style="margin-top:3vh">
                                ...
                                <div class="col-5">
                                    <label style="margin-right:10px"><input type="radio" name="people" value="alone">혼자</label>
                                    <label style="margin-right:10px"><input type="radio" name="people" value="friend">친구와</label>
                                    <label style="margin-right:10px"><input type="radio" name="people" value="family">가족과</label>
                                    <label style="margin-right:10px"><input type="radio" name="people" value="couple">연인과</label>
                                    <label style="margin-right:10px"><input type="radio" name="people" value="etc">기타</label>
                                </div>
                            </div>
                            <!-- 여행 스타일 선택-->
                            <div class="row justify-content-center" style="margin-top:3vh">
                                <div class="col-3">Who?</div>
                                <div class="col-5">
                                    <label style="margin-right:10px"><input type="radio" name="travel-type" value="alone">휴양</label>
                                    <label style="margin-right:10px"><input type="radio" name="travel-type" value="friend">관광</label>
                                    <label style="margin-right:10px"><input type="radio" name="travel-type" value="family">뚜벅이</label>
                                    <label style="margin-right:10px"><input type="radio" name="travel-type" value="couple">쇼핑</label>
                                    <label style="margin-right:10px"><input type="radio" name="travel-type" value="couple">패키지</label>
                                </div>
                            </div>
                            <!-- 제출 버튼임-->
                            <div>
                                <button type="submit" id="btn-submit" class="form-control" style="margin: 3vh 3vw;">완료</button>
                            </div>
                        </div>
                    </div>
                    <!-- 관광지 검색 end -->
